...
void Dawnbreaker::Q_table_init(){
    ...
    //std::cout<<" a  " << "  "<< q_table[state_before][0] << std::endl;
}
...
void Dawnbreaker::Q_iteration(GameWorld *world){
    ...
    */
    ...
    //std::cout << max_current_q_value << std::endl;
    std::cout<<" a  " << "  "<< q_table[state_before][0] << std::endl;
    ...
    std::cout<<" b  " << "  "<< q_table[state_before][0] << std::endl;
    std::cout<<" c  " << "  "<< max_current_q_value << "    "<< reward << std::endl;
